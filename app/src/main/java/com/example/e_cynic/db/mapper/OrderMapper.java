...
{
    public static Order mapCursorToOneOrder(Cursor cursor) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchFieldException, IOException {
        return (cursor.moveToFirst()) ? Mapper.mapCursorToOne(cursor, Order.class) : null;
    }

    public static List<Order> mapCursorToOrders(Cursor cursor) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, NoSuchFieldException, IOException {
